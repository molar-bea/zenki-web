...
.btn-flat--cancel {
  background: transparent; color: #4F6367; border: 1px solid #B8D8D8; margin-right: 0.5rem;
}
...
.feed-card {
  padding: 1.25rem; border: 1px solid #E0E2DB; border-radius: 8px;
  background: #fafafa; transition: border-color 0.2s;
}
.feed-card--pinned {
  border-color: #7A9E9F; background: #ffffff;
  box-shadow: 0 4px 12px rgba(122, 158, 159, 0.1);
}
.feed-card__header { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.75rem; }
.feed-card__meta { display: flex; align-items: center; gap: 0.75rem; }
.date { font-size: 0.8rem; color: #7A9E9F; font-weight: 500; }
.badge { font-size: 0.7rem; font-weight: 700; text-transform: uppercase; padding: 0.2rem 0.5rem; border-radius: 4px; }
...
.pin-btn--active { color: #4F6367; fill: #4F6367; }

.feed-card__title { margin: 0 0 0.5rem; font-size: 1.1rem; color: #191716; }
.feed-card__body { margin: 0; font-size: 0.95rem; line-height: 1.5; color: rgba(25, 23, 22, 0.8); white-space: pre-wrap; }
